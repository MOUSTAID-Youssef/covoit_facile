...
class TrajetSeeder extends Seeder
{
    public function run()
    {
        ...
        // Récupérer tous les conducteurs avec leurs véhicules
        $conducteurs = User::where('role', 'conducteur')->with('vehicules')->get();
        ...
        foreach ($conducteurs as $conducteur) {
            ...
            for ($i = 0; $i < $nombreTrajets; $i++) {
                ...
                $places_disponibles = $faker->numberBetween(1, $vehicule['nombre_places'] - 1);
                if ($statut === 'complet') {
                ...
                Trajet::create([
                    ...
                    'places_totales' => $vehicule['nombre_places'] - 1, // -1 pour le conducteur
